...
DEST_DIR=$(HOME)/
DIRS := .i3
FILES := .bash_aliases .bashrc .bash_profile .gitconfig .vim .vimrc .screenrc .hgrc .zshrc .i3/config .config/autostart/deactivate-touchpad.desktop .emacs .tmux.conf .ssh/config
